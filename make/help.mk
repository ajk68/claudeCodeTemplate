...
help: ## Show this help message
	...
	@echo "  make generate-context-full    All files in repo (~145K tokens)"
	@echo "  make generate-context-code    Code only, no docs/tests (~70K tokens)"
	@echo "  make generate-context-python  Python files only (~40K tokens)"
	@echo "  make generate-context-small   Compressed core code (~60K tokens)"
